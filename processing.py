...
# Define a function to convert tokens to integer indices based on a vocabulary
...
def main():
    ...
    with open(config.glove_vector_path, "rt") as f:
        emb = f.readlines()
    ...
    # Replace duplicate labels using a predefined mapping
